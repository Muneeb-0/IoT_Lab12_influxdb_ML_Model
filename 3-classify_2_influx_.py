...
INFLUXDB_TOKEN = "rA9meIHq0kEhLDvuetiNCmFAIOgbTnZ__tk-XHpPVKhfJ7hQ8cAMo2euf-ug__SKrUlPC3E2_tA4II-z7KG5_g=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "iotlab"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "iotlab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.48.78"  # ESP32's MQTT broker address
